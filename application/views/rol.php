    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-xs-12 col-md-12">
                ¿Seguro de eliminar a: <strong>{{rol.nombre_rol}}</strong> ?
            </div>
        </div>
    </div>     
...
<script type="text/ng-template" id="modalRol.html">  
    <form name="miForm" ng-submit="save();" novalidate>
    <div class="modal-header">
        <h3 class="modal-title" ng-if="accion == 'add'"><i class="fa fa-sitemap"></i> Nuevo Rol</h3>
        <h3 class="modal-title" ng-if="accion == 'edit'"><i class="fa fa-sitemap"></i> Editar Rol</h3>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
...
<div ng-show="$state.includes('rol.list')">
    <div class="content">
        <div class="row">
            <div class="col-md-12">  
