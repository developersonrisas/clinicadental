...
Flot Charts
*/
.controller('FlotInteractive', ['$scope', '$log','$element', function ($scope,$log,$element) {
    $scope.$log = $log;
	$scope.data = [];
...
.controller('FlotLineChart'  , function ($scope) {
        var sin = [], cos = [];
...
.controller('FlotAreaChart'  , function ($scope) {
...
.controller('FlotBarChart'   , function ($scope) {
    $scope.myData = [{
...
.controller('FlotDonutChart' , function ($scope) {
    $scope.myData = [
...
.controller('ChatController' , function ($scope,$http,$filter) {
	$http.get('views//partials/widgets/dialog1.json')
 ...
 */
 ...
 .directive('chat',function(){
	return {
		...
		templateUrl:'views/templates/direct-chat.html',
